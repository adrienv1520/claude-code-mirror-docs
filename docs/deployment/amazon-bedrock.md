...
Claude Code supports automatic credential refresh for AWS SSO and corporate identity providers. Add these settings to your Claude Code settings file (see [Settings](../configuration/settings.md) for file locations).
...
* You can use settings files for environment variables like `AWS_PROFILE` that you don't want to leak to other processes. See [Settings](../configuration/settings.md) for more information.
