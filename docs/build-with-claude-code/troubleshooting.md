...
3. **Specify formatting preferences**: Include formatting requirements in your prompts or project [memory](../configuration/memory.md) files.
...
* **Use project conventions**: Document your preferred markdown style in [CLAUDE.md](../configuration/memory.md)
